...
class ProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'watermark_copies'   => 'nullable|array',
            'watermark_copies.*' => 'nullable|array',
            'watermark_copies.*.text'     => 'nullable|string|max:255',
            'watermark_copies.*.opacity'  => 'nullable|numeric|min:0.1|max:1',
            'watermark_copies.*.rotation' => 'nullable|integer|min:-90|max:90',
            'watermark_copies.*.position' => 'nullable|string|in:center,tile,top-left,top-right,bottom-left,bottom-right',
            // Finishing fields
