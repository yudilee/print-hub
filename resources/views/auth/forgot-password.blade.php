...
<div class="text-center mb-6">
    ...
    <h1 class="text-xl font-bold tracking-tight text-white">Reset Password</h1>
    <p class="text-xs text-slate-400 mt-1">Enter your email to receive a recovery link</p>
</div>
